...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var buttonSelectBackground: Button
    private lateinit var ivSelectedBitmap: ImageView
    private lateinit var ivProcessedBitmap: ImageView
    private lateinit var ivBackgroundFill: ImageView
    ...
    private fun defineViews() {
        ...
        buttonSelectBackground = findViewById(R.id.buttonSelectBackground)
        ivSelectedBitmap = findViewById(R.id.ivSelectedBitmap)
        ivProcessedBitmap = findViewById(R.id.ivProcessedBitmap)
        ivBackgroundFill = findViewById(R.id.ivBackgroundFill)
    }
